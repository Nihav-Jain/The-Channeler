...
void AFP_FirstPersonCharacter::TurnAtRate(float Rate)
{
	...
	//GEngine->AddOnScreenDebugMessage(-1, 8.0f, FColor::Blue, FString::Printf(TEXT("BaseTurnRate: %f %f %f"), BaseTurnRate, Rate, Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds()));
	//UE_LOG(LogTemp, Warning, TEXT("BaseTurnRate: %f %f %f"), BaseTurnRate, Rate, Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}
...
void AFP_FirstPersonCharacter::LookUpAtRate(float Rate)
{
	...
	//GEngine->AddOnScreenDebugMessage(-1, 8.0f, FColor::Green, FString::Printf(TEXT("AFP_FirstPersonCharacter:BaseLookUpRate: %f"), BaseLookUpRate));
}
